...
class Ulasan_m extends CI_Model {
    ...
    public function get_ulasan($limit, $start, $rating){
    ...
    public function num_rows($rating=0){
    ...
    public function paginate($per_page, $rating){
        $this->load->library('pagination');
        $config['base_url'] = base_url('ulasan/index');
        $config['total_rows'] = $this->num_rows($rating);
