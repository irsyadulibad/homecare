    ...
    ***********************************-->
    <div id="main-wrapper">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown d-none d-md-flex">
                            <a href="javascript:void(0)" class="log-user"  data-toggle="dropdown">
                                <span><?= ucfirst($this->fungsi->user_login()->nama_lengkap); ?></span>  <i class="fa  f-s-14" aria-hidden="true"></i>
                            </a>
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="<?=base_url('assets/images/profile/'.$this->fungsi->user_login()->foto)?>" height="40" width="40" alt="">
                            </div>
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="<?= base_url('profile'); ?>"><i class="icon-user"></i> <span>Profil Saya</span></a>
                                        </li>
                                        <hr class="my-2">
                                        <li>
                                            <a href="<?= base_url('profile/editpass'); ?>"><i class="icon-lock"></i> <span>Kata Sandi</span></a>
                                        </li>
                                        <li><a href="<?=site_url('auth/logout')?>"><i class="icon-key"></i> <span>Keluar</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <?php if($this->fungsi->user_login()->role == 1) {?>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="<?=site_url('user')?>">Semua User</a></li>
                            <li><a href="<?=site_url('user/medis')?>">Paramedis</a></li>
                            <li><a href="<?=site_url('user/pengguna')?>">Pengguna</a></li>
                    ...
                    <?php if($this->fungsi->user_login()->role == 1) {?>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-user menu-icon"></i><span class="nav-text">Pasien</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('pasien/add')?>">Tambah Pasien</a></li>
                    ...
                    <?php if($this->fungsi->user_login()->role == 3) {?>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-people menu-icon"></i><span class="nav-text">Pasien</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('pasien/add')?>">Tambah Pasien</a></li>
                            <li><a href="<?=site_url('pasien/user')?>">Pasien</a></li>
                        </ul>
                        <?php }?>
                    </li>
                    <li>
                    <?php if($this->fungsi->user_login()->role == 1) {?>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Layanan</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('layanan/add')?>">Tambah Layanan</a></li>
                    ...
                    <?php if($this->fungsi->user_login()->role == 1) {?>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i><span class="nav-text">Pesanan</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('cart')?>">Tambah Pesanan</a></li>
                            <li><a href="<?=site_url('invoice')?>">Pesanan</a></li>
                        </ul>
                        <?php }?>
                    </li>
                    <li>
                    <?php if($this->fungsi->user_login()->role == 2) {?>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('pesanan/dimedis')?>">Pesanan</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?= base_url('pembayaran'); ?>" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Pembayaran</span>
                        </a>
                    </li>
                    <?php }?>
                    <li>
                    <?php if($this->fungsi->user_login()->role == 3) {?>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('cart')?>">Tambah Pesanan</a></li>
                            <li><a href="<?=site_url('pesanan/diuser')?>">Pesanan</a></li>
                        </ul>
                        <?php }?>
                    </li>
                    <li>
                        <a href="<?= base_url('riwayat'); ?>">
                            <i class="icon-refresh menu-icon"></i><span class="nav-text">Riwayat</span>
                        </a>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?=site_url('ulasan')?>">Daftar Ulasan</a></li>
                        </ul>
                    </li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://antosfery.com">Antos Fery</a> 2019</p>
            </div>
        </div>
        <!--**********************************
            Footer end
