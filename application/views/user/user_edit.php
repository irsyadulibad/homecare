<div class="row justify-content-center">
	<div class="col-12 col-md-6 col-lg-6">
		<div class="card">
			<div class="card-body">
			<?= form_open(''); ?>
				<input type="hidden" name="user_id" value="<?= $user['id_pengguna']; ?>">
				<input type="hidden" name="prev" value="<?= $this->input->get('prev', true); ?>">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="username" value="<?= $user['nama_pengguna'] ?>">
				...
				<div class="form-group">
					...
					<select name="level" class="form-control">
						...
						<option value="2"  <?= $user['role'] == 2 ? 'selected' : ''; ?>>Medis</option>
						<option value="4"  <?= $user['role'] == 4 ? 'selected' : ''; ?>>Dokter</option>
						<option value="3"  <?= $user['role'] == 3 ? 'selected' : ''; ?>>Pengguna</option>
					</select>
				</div>
				<div class="form-group">
